...
\begin{recipe}{Carla's Leek and Cheese Muffins}
  \ingredient{175\,g Weizenmehl}
  \ingredient{1 TL Backpulver}
  \ingredient{\sfrac{1}{4} TL Natron}
  \ingredient{\sfrac{1}{2} TL Piment}
  in einer Rührschüssel vermischen.

  \ingredient{1 Ei}
  verquirlen, mit
  \ingredient{50\,ml Milch}
  \ingredient{100\,ml Pflanzenöl}
  unter die Trockenmasse rühren.

  \ingredient{1 Stange Lauch (nur weißer/hellgrüner Teil)}
  \ingredient{75\,g Cheddar}
...
\begin{recipe}{Cornbread Muffins}
  \ingredient{85\,g Butter}
  in einer Pfanne zerlassen.

  \ingredient{1 kleine Zwiebel}
  \ingredient{1 Habanero, entkernt}
  fein hacken, mit
  \ingredient{1 Dose Mais}
  in der Butter ca. 5–10 Minuten garen.

  \ingredient{140\,g Weizenmehl}
  \ingredient{140\,g Maismehl}
  \ingredient{2 TL Backpulver}
  \ingredient{50\,g kräftiger Cheddar, geraspelt}
